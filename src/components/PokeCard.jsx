...
export default function PokeCard(props) {
    ...
    useEffect(() => {
        ...
        //2. check if the selectedPokemon is in the cache, otherwise fetch from the api
        ...
        fetchPokemonData()
        //if we fetch the info from the api, make sure to save it to the cache for next time
